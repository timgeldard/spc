...
function SummaryBar({ rows }: SummaryBarProps) {
  ...
  const cards = [
    { label: 'Characteristics', value: total, border: 'border-slate-200 bg-slate-50 text-slate-800' },
    { label: 'Highly Capable (≥1.67)', value: excellent, border: 'border-emerald-200 bg-emerald-50 text-emerald-700' },
    { label: 'Capable (≥1.33)', value: good, border: 'border-green-200 bg-green-50 text-green-700' },
    { label: 'Marginal (≥1.00)', value: marginal, border: 'border-amber-200 bg-amber-50 text-amber-700' },
    { label: 'Not Capable (<1.00)', value: poor, border: 'border-red-200 bg-red-50 text-red-700' },
  ]
  ...
  return (
    <div className={scorecardLayoutClass}>
      <div className={scorecardHeaderClass}>
        ...
        <p className={scorecardSubClass}>Click any row to open its control chart</p>
      </div>
      ...
      {viewMode === 'table' && (
        <>
          <p className={stabilityNoteClass}>
